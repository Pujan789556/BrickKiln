...
public class MarkerActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tSpecTech.setIndicator("TECHNICAL DETAILS",getResources().getDrawable(R.drawable.tech));
        ...
        tSpecSocio.setIndicator("SOCIO-ECONOMIC",getResources().getDrawable(R.drawable.socio));
